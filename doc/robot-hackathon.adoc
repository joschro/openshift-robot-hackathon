...
==== Mapping the Key to your Robot

To map your newly created *Key* to your teams robot, the robot admin team has 
to configure the Hub-Controller application. 

So please:

* Take note of your API key
* Together with your team name send it to dbrintzi@redhat.com
* Daniel will enter it into the mapping table, feel free to look over his 
shoulder...
...
roboteam1-8 . Open your browser and access the OpenShift web UI:

----
https://infranode-9d00.generic.opentlc.com:8443/
----

* Login as your team user, e.g. *roboteam1*, the password will be provided. 
* Look around

If you prefer the commandline *oc* tool, use an SSH client to connect to the 
cluster gateway:

----
# ssh roboteam1@workstation-9d00.rhpds.opentlc.com
----

Login to the OpenShift cluster is made easy by using the 
web UI. In the web UI click on the *?* button in the upper right and copy the 
*oc* command line. Example:

----
oc login https://infranode-9d00.generic.opentlc.com:8443 --token=<hidden>
----
...
----
http://che-eclipse-che.apps-9d00.generic.opentlc.com/
----

Login as your team user, example:
...
After login you are in the Workspace management view of Che. Start your 
workspace in Che:
...
** Chosse *GIT*
** *URL*: 
\http://gogs-cicd-admin.apps-9d00.generic.opentlc.com/gogs/robot-hackathon-<your 
team name>.git
...
This will download the client and add it to $PATH.
...
Task: Make your robot drive in a square with approx 20 cm length
...
* Mission 2 : Prometheus / Grafana Dashboard (Power, Distance)
* Mission 3 : Use Distance Sensor: Stop in front of the robot barrier
* Mission 4 : Navigate a predefined labyrinth
* Mission 5 : Navigate an unknown labyrinth
